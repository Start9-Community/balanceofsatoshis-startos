...
export const v_22_0_1_2 = VersionInfo.of({
  version: '22.0.1:2',
  releaseNotes: {
    en_US: 'Added Telegram autostart and connect code UI action.',
    es_ES: 'Actualizado a start-sdk 1.5.2.',
    de_DE: 'Telegram-Autostart und Connect-Code-UI hinzugefuegt.',
